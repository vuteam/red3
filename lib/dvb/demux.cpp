...
RESULT eDVBSectionReader::connectRead(const sigc::slot1<void,const __u8*> &r, ePtr<eConnection> &conn)
{
...
RESULT eDVBPESReader::connectRead(const sigc::slot2<void,const __u8*,int> &r, ePtr<eConnection> &conn)
{
